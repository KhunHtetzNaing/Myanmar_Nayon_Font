...
Sub b1_Click
	...
	'	If File.Exists(File.DirRootExternal & "/MIUI/theme","Nayon.mtz") = True Then File.Delete(File.DirRootExternal,"MIUI/theme/Nayon.mtz")
	'	File.Copy(File.DirAssets,"Nayon.mtz",File.DirRootExternal & "/MIUI/theme","Nayon.mtz")
