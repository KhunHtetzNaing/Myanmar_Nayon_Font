...
public class vivo extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (isFirst) {
			processBA = new BA(this.getApplicationContext(), null, null, "com.htetznaing.mmnayonfont", "com.htetznaing.mmnayonfont.vivo");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "com.htetznaing.mmnayonfont", "com.htetznaing.mmnayonfont.vivo");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "com.htetznaing.mmnayonfont.vivo", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
mostCurrent._lb.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 39;BA.debugLine="lb.Text = \"	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ C";
mostCurrent._lb.setText(BA.ObjectToCharSequence("	Install  ကိုနွိပ္ပါ။ ျပီးရင္ေအာက္ပါ Change Font1 ကိုနွိပ္ပါ Nayon.txj (သို့) Nayon.itz ကိုဖြင့္ၿပီး Apply လုပ္ေပးလိုက္ပါ မရခဲ့ရင္ Change Font2 ကိုနွိပ္ျပီး Myanmar Nayon နာမည္နဲ့ Theme ကိုေရြးေပးလိုက္ပါ။ နဂိုမူလေဖာင့္ကိုျပန္ထားခ်င္ရင္ Change Font2 ကိုနွိပ္ျပီး Default ကိုျပန္ေရြးထားနိုင္ပါတယ္။"));
...
mostCurrent._b3.Initialize(mostCurrent.activityBA,"b3");
 //BA.debugLineNum = 75;BA.debugLine="b3.Text = \"Tutorial\"";
...
mostCurrent._tlb.setText(BA.ObjectToCharSequence("Vivo"));
 //BA.debugLineNum = 85;BA.debugLine="tlb.Color = Colors.rgb(76, 175, 80)";
...
mostCurrent._sm._additem("More App",anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"moreapp.png"),(Object)(8));
 //BA.debugLineNum = 102;BA.debugLine="sm.AddItem(\"About\",LoadBitmap(File.DirAssets,\"abo";
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._share.getObject()),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (40))),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (12.5)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (30)));
 //BA.debugLineNum = 116;BA.debugLine="Banner.Initialize2(\"Banner\",\"ca-app-pub-417334857";
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Nayon.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Vivo Myanmar Font/Nayon.txj");};
 //BA.debugLineNum = 142;BA.debugLine="File.Copy(File.DirAssets,\"Nayon.txj\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Nayon.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Nayon.txj");
 //BA.debugLineNum = 144;BA.debugLine="If File.Exists(File.DirRootExternal & \"/Vivo Myan";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Nayon.itz")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Vivo Myanmar Font/Nayon.itz");};
 //BA.debugLineNum = 145;BA.debugLine="File.Copy(File.DirAssets,\"Nayon.itz\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Nayon.itz",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Vivo Myanmar Font","Nayon.itz");
...
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Nayon.txj")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Download/i Theme/Font/Nayon.txj");};
 //BA.debugLineNum = 165;BA.debugLine="File.Copy(File.DirAssets,\"Nayon.txj\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Nayon.txj",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Nayon.txj");
 //BA.debugLineNum = 167;BA.debugLine="If File.Exists(File.DirRootExternal & \"/Download/";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Nayon.itz")==anywheresoftware.b4a.keywords.Common.True) { 
anywheresoftware.b4a.keywords.Common.File.Delete(anywheresoftware.b4a.keywords.Common.File.getDirRootExternal(),"Download/i Theme/Font/Nayon.itz");};
 //BA.debugLineNum = 168;BA.debugLine="File.Copy(File.DirAssets,\"Nayon.itz\",File.DirRoot";
anywheresoftware.b4a.keywords.Common.File.Copy(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Nayon.itz",anywheresoftware.b4a.keywords.Common.File.getDirRootExternal()+"/Download/i Theme/Font","Nayon.itz");
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 263;BA.debugLine="copy.setText(\"#Myanmar_Nayon_Font App! Beautiful";
...
mostCurrent._copy.clrText(mostCurrent.activityBA);
 //BA.debugLineNum = 241;BA.debugLine="copy.setText(\"#Myanmar_Nayon_Font App! Beautifu";
mostCurrent._copy.setText(mostCurrent.activityBA,"#Myanmar_Nayon_Font App! Beautiful Myanmar Zawgyi Font Style!	You can Use in Samung, Oppo,Vivo, Huawei (EMUI) and Xiaomi (MIUI) without Root Access!!!! Download Free at : http://www.htetznaing.com/search?q=Myanmar+Nayon+Font");
